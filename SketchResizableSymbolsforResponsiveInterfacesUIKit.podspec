Pod::Spec.new do |spec|
  spec.name          = 'SketchResizableSymbolsforResponsiveInterfacesUIKit'
  spec.version       = '1.0'
  spec.license       = { :type => 'MIT' }
  spec.homepage      = 'http://www.animaapp.com'
  spec.authors       = { 'czaralves@gmail.com' => '' }
  spec.summary       = 'SketchResizableSymbolsforResponsiveInterfaces UI Kit'
  spec.source        = { :git => '' }
  spec.source_files  = 'SketchResizableSymbolsforResponsiveInterfacesUIKit/*.{h,m,swift}'
  ...
  spec.resources     = ['SketchResizableSymbolsforResponsiveInterfacesUIKit/**/*.{xcassets,storyboard}', 'SketchResizableSymbolsforResponsiveInterfacesUIKit/Resources/**/*.*']
